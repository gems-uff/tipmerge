...
public class Experiment {
    ...
    public Map<String, Integer> getDatasFromMergesABC(File file) throws IOException {
    ...
    private boolean hasEnoughtDevelopers(MergeFiles mergeFiles) {
        ...
        return (mergeFiles.getCommittersOnBranchOne().size() > 1 && mergeFiles.getCommittersOnBranchTwo().size() > 1);
